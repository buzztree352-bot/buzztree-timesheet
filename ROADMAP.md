...
Full spec: [SPEC-payslips-and-pay.md](SPEC-payslips-and-pay.md) (pay items, formulas proven on September slips, PAYE/UIF/SDL/ETI, deduction order, YTD).
...
Full spec: [SPEC-payslips-and-pay.md](SPEC-payslips-and-pay.md) §4–6 (template, generator with DRAFT / lock / v2 reissues, 9 print types).
